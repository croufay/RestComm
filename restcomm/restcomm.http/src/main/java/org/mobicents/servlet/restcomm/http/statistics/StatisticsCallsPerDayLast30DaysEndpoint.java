...
public abstract class StatisticsCallsPerDayLast30DaysEndpoint extends AbstractEndpoint{
...
@Context
    ...
    public StatisticsCallsPerDayLast30DaysEndpoint() {
        super();
    ...
    public void init() {
        ...
        final StatisticsCallsPerDayLast30DaysConverter converter = new StatisticsCallsPerDayLast30DaysConverter(configuration);
 ...
 protected Response getStatistics(final String accountSid,  final MediaType responseType) {
        ...
        final List<StatisticsCallsPerDayLast30Days> statistics =  dao.getCallsPerDayLast30Days();
