...
public abstract class StatisticsTopTenSMSEndpoint extends AbstractEndpoint{
...
@Context
   ...
   public StatisticsTopTenSMSEndpoint() {
       super();
   }
...
protected Response getStatistics(final String accountSid,  final MediaType responseType) {
       ...
       final List<StatisticsTopTenSMS> statistics =  dao.getTopTenSMS( );
