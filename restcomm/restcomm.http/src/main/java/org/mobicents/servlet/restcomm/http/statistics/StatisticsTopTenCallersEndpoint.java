...
public abstract class StatisticsTopTenCallersEndpoint extends AbstractEndpoint{
...
@Context
    ...
    public StatisticsTopTenCallersEndpoint() {
        super();
    }
 ...
 protected Response getStatistics(final String accountSid,  final MediaType responseType) {
        ...
        final List<StatisticsTopTenCallers> statistics =  dao.getTopTenCallers( );
