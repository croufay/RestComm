...
public abstract class StatisticsTotalSMSLast24HoursEndpoint extends AbstractEndpoint{
...
@Context
   ...
   // protected XStream xstream;
    ...
    public StatisticsTotalSMSLast24HoursEndpoint() {
        super();
    }
    ...
    public void init() {
        ...
        final StatisticsTotalSMSLast24HoursConverter converter = new StatisticsTotalSMSLast24HoursConverter(configuration);
 ...
 protected Response getTotalSMSLast24Hours(final String accountSid,final MediaType responseType) {
     try {
         secure(accountsDao.getAccount(accountSid), "RestComm:Read:Statistics");
     } catch (final AuthorizationException exception) {
         return status(UNAUTHORIZED).build();
     }
     final StatisticsTotalSMSLast24Hours statistics =    dao.getTotalSMSLast24Hours();
