...
public abstract class StatisticsSMSPerMonthLast12MonthsEndpoint extends AbstractEndpoint{
...
@Context
    ...
    public StatisticsSMSPerMonthLast12MonthsEndpoint() {
        super();
    }
    ...
    public void init() {
        ...
        final StatisticsSMSPerMonthLast12MonthsConverter converter = new StatisticsSMSPerMonthLast12MonthsConverter(configuration);
 ...
 protected Response getStatistics(final String accountSid,  final MediaType responseType) {
        ...
        final List<StatisticsSMSPerMonthLast12Months> statistics =  dao.getSMSPerMonthLast12Months() ;
