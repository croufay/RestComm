...
public abstract class StatisticsSMSPerDayLast30DaysEndpoint extends AbstractEndpoint{
...
@Context
    ...
    public StatisticsSMSPerDayLast30DaysEndpoint() {
        super();
    ...
    public void init() {
        ...
        final StatisticsSMSPerDayLast30DaysConverter converter = new StatisticsSMSPerDayLast30DaysConverter(configuration);
 ...
 protected Response getStatistics(final String accountSid,  final MediaType responseType) {
        ...
        final List<StatisticsSMSPerDayLast30Days> statistics =  dao.getSMSPerDayLast30Days();
